...
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_68__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _validator = __webpack_require__(69);
	...
	var View = function (_Component) {
	    ...
	    _createClass(View, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var self = this.props.context || this;
	    ...
	    _createClass(View, [{
	        ...
	        value: function getDatas() {
	            ...
	            if (keys.length) {
	                this.request.all(promises, function () {
	                    for (var _len = arguments.length, datas = Array(_len), _key = 0; _key < _len; _key++) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'view', ref: 'view', style: this.props.style },
	                this.props.children
	            );
	        }
	    }]);
	...
	var Request = function () {
	    ...
	    _createClass(Request, [{
	        ...
	        value: function config(_config) {
	            this.configs = Object.assign(this.configs, _config);
	            // this.axios(this.configs);
	            return this.configs;
	        }
	    }, {
	        key: 'geneConfig',
	        value: function geneConfig(config) {
	            if (!config) {
	                return;
	            }
	        ...
	        key: 'ajax',
	        value: function ajax(url, config) {
	            config.url = url || '';
	        ...
	        key: 'all',
	        value: function all(promises, done) {
	            done = done || function () {};
	            this.axios.all(promises).then(this.axios.spread(function () {
			...
			/***/function (module, exports, __webpack_require__) {
				...
				module.exports = function xhrAdapter(resolve, reject, config) {
					...
					request.onload = function handleLoad() {
						...
						(request.status >= 200 && request.status < 300 || !('status' in request) && request.responseText ? resolve : reject)(response);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InternalPropTypes = __webpack_require__(42);
	...
	var _routerWarning = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createLocation2 = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibActions = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibUseBasename = __webpack_require__(60);

	var _historyLibUseBasename2 = _interopRequireDefault(_historyLibUseBasename);

	var _historyLibCreateMemoryHistory = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateBrowserHistory = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Validator = exports.Tip = exports.Rules = undefined;
	...
	var Rules = exports.Rules = function () {
	    ...
	    _createClass(Rules, [{
	        ...
	        value: function initRules() {
	            this.addRule('required', function (ele) {
	                var msg = arguments.length <= 1 || arguments[1] === undefined ? '不能为空' : arguments[1];
	            ...
	            this.addRule('maybe', function (ele) {
	                return {
	                    status: true
	                };
	            });
	...
	var Tip = exports.Tip = function () {
	    ...
	    _createClass(Tip, [{
	        ...
	        key: 'setPosition',
	        value: function setPosition(offset) {
	...
	var Validator = exports.Validator = function () {
	    ...
	    _createClass(Validator, [{
	            ...
	            for (var name in this.validators) {
	                if (this.validators.hasOwnProperty(name)) {
	                    (function () {
	                        ...
	                        var rules = (validator.rule || '').split('|').filter(function (v) {
	                        ...
	                        if (rules.length) {
	                            rules.forEach(function (v) {
	                                ...
	                                var ruleName = args[0];
	                                var rule = _this2.rules[args[0]];

	                                if (rule) {
	                                    args.shift();
	                                    args.unshift(validator.ele);

	                                    _this2.checks[name].push({
	                                        rule: rule,
	                                        args: args
	                                    });
	                                }
	        ...
	        value: function check(name) {
	            ...
	            var checkEle = function checkEle(name) {
	                var result = {};
	                var data = _this3.checkEle(name);
	            ...
	            // 检查全部元素
	            if (!name) {
	                for (var _name in this.checks) {
	                    Object.assign(result, checkEle(_name));
	                }
	            } else {
	        ...
	        value: function checkEle(name) {
	            ...
	            // 检查特定元素
	            this.checks[name].forEach(function (v) {
	                // let args = utils.clone(v.args);
	                var res = v.rule.apply(_this4, v.args);

	                if (res.status !== true) {
	                    isPass = false;
	                    _this4.tip.show(v.args[0], res.msg);
	                    return false;
	                } else {
	                    _this4.tip.hide();
	                }
...
/***/ function(module, exports) {
	...
	exports.isVisiable = function (elem) {
